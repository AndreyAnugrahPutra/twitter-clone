...
class TweetSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('tweets')->insert([
            'name' => 'Andrey Anugrah Putra',
            'handle' => '@andrey_a_putra',
            'image' => 'https://randomuser.me/api/potraits/men/40.jpg',
            'tweet' => 'Testing a tweet for my twitter clone project, this is so freakin exciting!!!',
            'file' => '/videos/testVideos.mp4',
            'is_video' => true,
            'comments' => '35',
            'retweets' => '54',
            'likes' => '88',
